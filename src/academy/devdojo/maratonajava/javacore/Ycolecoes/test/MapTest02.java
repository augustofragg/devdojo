...
public class MapTest02 {
    public static void main(String[] args) {
        ...
        Map<Consumidor,Manga> consumingsManga = new HashMap<>();
        consumingsManga.put(consumidor1,manga1);
        consumingsManga.put(consumidor2,manga4);
        for(Map.Entry<Consumidor,Manga> entry: consumingsManga.entrySet()) {
